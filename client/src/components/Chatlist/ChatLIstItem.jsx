...
function ChatLIstItem({ data, isContactsPage  }) {
    ...
    if (!isContactsPage) {
      dispatch({
        ...
        user: {
          ...
          about: data.about,
          _id:
            userInfo._id === data.senderId._id
              ? data.receiverId._id
              : data.senderId._id,
        },
      });
  ...
  return (
    ...
    >
      <div className="min-w-fit px-5 pt-3 p-1">
          ...
          <div className="flex justify-between w-full">
            <span className="text-secondary line-clamp-1 text-sm ">
              {isContactsPage ? (
                ...
                <div className="flex items-center gap-1 max-w-[200px] sm:max-w-[200px] md:max-w-[300px] lg:max-w-[200px] xl:max-w-[300px]">
                  {
                    data.senderId._id ===userInfo._id && <MessageStatus messageStatus={data.messageStatus}/>
                  }
                  {
                    data.type === "text" && (
